...
import autonavi.online.framework.annotation.message.MessageListenerHandler;
...
public class ConfigMessageListener {
	...
	public void initMessageListener(final BeanDefinitionRegistry registry)
		...
		// 定义监听端口
		MessageListenerBeanDefinition.getPropertyValues().add("prot",
				Miscellaneous.aof_messageListener_prot);
		// 定义netInterfaceName
