...
import autonavi.online.framework.annotation.sharding.ShardingTransactional;
...
import autonavi.online.framework.jdbc.transactional.support.ShardingTransactionAspectSupport;
...
public class ShardingTransactionAspect extends ShardingTransactionAspectSupport {
	...
	@Pointcut("@annotation(autonavi.online.framework.annotation.sharding.ShardingTransactional)")
...
//				.setTransactionAttribute(transactionAttribute);
		...
		return invokeWithinTransaction(method, proceedingJoinPoint.getTarget().getClass(),
