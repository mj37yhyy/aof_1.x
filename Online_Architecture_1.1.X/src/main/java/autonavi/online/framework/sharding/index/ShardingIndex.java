...
import autonavi.online.framework.exception.DBTableNotFoundException;
import autonavi.online.framework.jdbc.dao.SqlPrint;
...
public class ShardingIndex {
	 ...
	 */
	public void maintainShardingIndexEntity() throws Exception {
