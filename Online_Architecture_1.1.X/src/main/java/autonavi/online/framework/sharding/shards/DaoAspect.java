...
public class DaoAspect {
	...
	private Object customPointcut(ProceedingJoinPoint proceedingJoinPoint,
		...
		DaoEntity daoEntity = initParameters.getDaoEntity(proceedingJoinPoint, tableOperation);
		swlogger.stop();
	...
	@Pointcut(value = "@annotation(autonavi.online.framework.annotation.sharding.Select)")
	public void customSelectPointcut() {
	}

	@Pointcut(value = "@annotation(autonavi.online.framework.annotation.sharding.Update)")
	public void customUpdatePointcut() {
	}

	@Pointcut(value = "@annotation(autonavi.online.framework.annotation.sharding.Insert)")
	public void customInsertPointcut() {
	}

	@Pointcut(value = "@annotation(autonavi.online.framework.annotation.sharding.Delete)")
